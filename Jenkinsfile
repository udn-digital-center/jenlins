 	...
 	stage('Deploy'){
            steps {
                ...
                sshagent (credentials: ['connetc_to_gcp_jenkins_demo_server']) {
                    ...
                    //sh 'rsync --exclude ".git" -avzhi /var/jenkins_home/workspace/pipline-demo jenkins@34.72.86.38:/var/www/html'
                    //sh 'rsync --exclude ".git" -aunv /var/jenkins_home/workspace/pipline-demo jenkins@34.72.86.38:/var/www/html'
                    sh 'rsync --exclude ".git" -av --update /var/jenkins_home/workspace/pipline-demo jenkins@34.72.86.38:/var/www/html'
                }
            }
        }
    }
